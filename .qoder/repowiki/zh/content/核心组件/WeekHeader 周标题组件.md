...
### 样式系统
组件采用scoped样式，确保样式隔离和可维护性。主要样式特性包括：
- 弹性布局，平均分配空间
- 圆角边框和阴影效果
- 分割线区分不同周单元
- 字体大小和颜色的层次化设计
...
WeekHeader组件的样式设计体现了现代UI设计的最佳实践：

#### 视觉层次结构
- **背景色**: #f0f0f0，提供温和的对比度
- **边框**: 1px solid #ccc，确保清晰的分隔
- **圆角**: 6px，营造柔和的视觉感受
- **分割线**: 每个单元格右侧1px分割线，突出边界

#### 文本层级设计
- **周次标签**: 13px字体，粗体，#333颜色，强调重要信息
- **日期范围**: 12px字体，#666颜色，轻微的顶部边距
- **字体选择**: 系统默认字体族，确保跨平台兼容性

#### 响应式布局
组件采用flex布局，能够自适应容器宽度变化。每个周单元格使用flex: 1，确保6个单元格平均分布。
